public class Board {
    ...
    public void newBoard() {
        ...
        this.board[0][4] = new Tile(new King("KingB", ChessColor.Black));
        this.board[0][3] = new Tile(new Queen("QB", ChessColor.Black));
        ...
        this.board[7][4] = new Tile(new King("KingW", ChessColor.White));
        this.board[7][3] = new Tile(new Queen("QW", ChessColor.White));
    ...
    public boolean unObstructedPathDiagnol(int startX, int startY, int endX, int endY) {
        ...
        int i = startX + rowMove;
        int j = startY + colMove;

        for (; i != endX && j != endY; i += rowMove, j += colMove) {
